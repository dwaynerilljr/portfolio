  ...
  return (
    <section className='grid sm:pb-24 gap-12 m-10 sm:m-0 grid-cols-1 uppercase sm:mx-40 sm:grid-cols-4 sm:gap-10 font-primary'>
        ...
        <div className='sm:col-span-2 col-span-1 flex flex-col gap-y-2'>
            ...
            <header className='uppercase text-lg sm:text-xl'>Christmas List</header>
            <div className='flex justify-between items-center text-sm sm:text-base font-thin'>
                ...
                <div className='hidden sm:flex gap-x-1 sm:gap-x-4 font-semibold text-teal-400'>
                    <a href="https://github.com/dwaynerilljr/christmas-list-app" target="_blank" rel="noreferrer" className='focus:outline-teal-400 border-b border-transparent hover:border-b hover:border-b-white'>Github</a>
                    <a href="https://xmas-list.netlify.app/" target="_blank" rel="noreferrer" className='focus:outline-teal-400 border-b border-transparent hover:border-b hover:border-b-white'>Demo</a>
                </div>
