    ...
    return (
        <section className='sm:h-75v sm:mx-40 m-8 sm:p-0 grid font-primary sm:items-center' id='hero'>
            <div className="flex p-2 sm:p-0 sm:gap-14 gap-3 flex-col items-center sm:items-start">
                ...
                <a href="https://www.google.com" className="border-2 sm:text-base text-sm items-center sm:gap-x-2 flex sm:font-extrabold p-2 uppercase max-w-min sm:px-4 sm:py-3">projects <AiOutlineArrowRight className='text-teal-400' /></a>
            </div>
        </section>
    )
}